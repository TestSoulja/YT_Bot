...
def func(message):
	...
	if message.text == "_Что я могу?_":
		...
		# Stage
		bot.send_photo(message.chat.id, open("/Users/s.ekker/PycharmProjects/YT_Bot/AUF/Wolf/" + s + "_.jpg", "rb"), reply_to_message_id=message.message_id, reply_markup=markup)
		z = 0
		...
		bot.send_message(message.chat.id, text="Хто я?".format(message.from_user), reply_to_message_id=message.message_id, reply_markup=markup)
		z = 0
		...
		markup.add(btn1)
		bot.send_message(message.chat.id, text="Пришли ссылку на видос ютуб".format(message.from_user), reply_to_message_id=message.message_id, reply_markup=markup)
		z = 2
		...
		bot.send_message(message.chat.id, text="To Pc OK".format(message.from_user), reply_to_message_id=message.message_id, reply_markup=markup)
		btn1 = types.KeyboardButton("_Скачать видео_")
		btn2 = types.KeyboardButton("_В начало_")
		markup.add(btn1, btn2)
		...
		btn2 = types.KeyboardButton("_Выключить_")
		markup.add(btn1, btn2)
		bot.send_message(message.chat.id, text="Привет!! Вы снова со мной :3".format(message.from_user), reply_to_message_id=message.message_id, reply_markup=markup)
		z = 0
